...
$this->setState('avatar',"/images/admin/avatar1.png");
}

if ($info_usuario->avatar==2) {
$this->setState('avatar',"/images/admin/avatar2.png");
}

if ($info_usuario->avatar==3) {
$this->setState('avatar',"/images/admin/avatar3.png");
}

if ($info_usuario->avatar==4) {
$this->setState('avatar',"/images/admin/avatar4.png");
}

if ($info_usuario->avatar==5) {
$this->setState('avatar',"/images/admin/avatar5.png");
}
