...
// if you want to use SMTP, uncomment and configure lines below to your needs
	'Mailer' => 'smtp',
	'Host' => 'mail.pixtudios.net',
	'Port' => 587,
    //'SMTPSecure' => 'tls',
	'SMTPAuth' => true,
	'Username' => 'mauricio@pixtudios.net',
	'Password' => '20Mau14',

/*		$mail->IsSMTP ();
		$mail->Mailer = "smtp";
		$mail->Host = "mail.pixtudios.net";
		$mail->SMTPAuth = false;
		$mail->Username = "pruebas@pixtudios.net";
		$mail->Password = "Pru2020";
		$mail->From = "pruebas@pixtudios.net";*/
