...
class ImagenesController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Imagenes']))
		{
            ...
            $fileName = "imagen_{$rnd}.jpg";  // numero aleatorio  + nombre de archivo
            ...
            if($model->save())
            {
                ...
                {
                    $imagenFile->saveAs(Yii::app()->basePath.'/../pics/imagenes/'.$fileName);
				    $image = Yii::app()->image->load(Yii::app()->basePath.'/../pics/imagenes/'.$model->imagen);
				   // $image->resize(800, 600);
				    $image->save(Yii::app()->basePath.'/../pics/imagenes/'.$model->imagen);  
                }
	...
	public function actionUpdate($id)
	{
        ...
        if(isset($_POST['Imagenes']))
        {
            ...
            $_POST['Imagenes']['imagen'] = $model->imagen;
            ...
            if($model->save()){
                ...
                if(!empty($subiendoImagen)){
                    $subiendoImagen->saveAs(Yii::app()->basePath.'/../pics/imagenes/'.$model->imagen);
                    $image = Yii::app()->image->load(Yii::app()->basePath.'/../pics/imagenes/'.$model->imagen);
				    //$image->resize(800, 600);
				    $image->save(Yii::app()->basePath.'/../pics/imagenes/'.$model->imagen);  
                } 
