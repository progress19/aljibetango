...
class MenusController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Menus']))
		{
            ...
            if($model->save())
            {
                ...
                {
                    $imagenFile->saveAs(Yii::app()->basePath.'/../pics/menus/'.$fileName);
				    $image = Yii::app()->image->load(Yii::app()->basePath.'/../pics/menus/'.$model->imagen);
				   // $image->resize(800, 600);
				    $image->save(Yii::app()->basePath.'/../pics/menus/'.$model->imagen);  
                }
	...
	public function actionUpdate($id)
	{
        ...
        if(isset($_POST['Menus']))
        {
            ...
            $_POST['Menus']['imagen'] = $model->imagen;
            ...
            if($model->save()){
                ...
                if(!empty($subiendoImagen)){
                    $subiendoImagen->saveAs(Yii::app()->basePath.'/../pics/menus/'.$model->imagen);
                    $image = Yii::app()->image->load(Yii::app()->basePath.'/../pics/menus/'.$model->imagen);
				    //$image->resize(800, 600);
				    $image->save(Yii::app()->basePath.'/../pics/menus/'.$model->imagen);  
                } 
