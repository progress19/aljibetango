...
class ShowsController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Shows']))
		{
            ...
            if($model->save())
            {
                ...
                {
                    $imagenFile->saveAs(Yii::app()->basePath.'/../pics/shows/'.$fileName);
				    $image = Yii::app()->image->load(Yii::app()->basePath.'/../pics/shows/'.$model->imagen);
				   // $image->resize(800, 600);
				    $image->save(Yii::app()->basePath.'/../pics/shows/'.$model->imagen);  
                }
	...
	public function actionUpdate($id)
	{
        ...
        if(isset($_POST['Shows']))
        {
			...
			//print_r($_POST['Shows']);die();

            $_POST['Shows']['imagen'] = $model->imagen;
            ...
            if($model->save()){
                ...
                if(!empty($subiendoImagen)){
                    $subiendoImagen->saveAs(Yii::app()->basePath.'/../pics/shows/'.$model->imagen);
                    $image = Yii::app()->image->load(Yii::app()->basePath.'/../pics/shows/'.$model->imagen);
				    //$image->resize(800, 600);
				    $image->save(Yii::app()->basePath.'/../pics/shows/'.$model->imagen);  
                } 
	 ...
	 * @param Shows $model the model to be validated
	 */
