...
class CavaController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Cava']))
		{
            ...
            if($model->save())
            {
                ...
                {
                    $imagenFile->saveAs(Yii::app()->basePath.'/../pics/cava/'.$fileName);
				    $image = Yii::app()->image->load(Yii::app()->basePath.'/../pics/cava/'.$model->imagen);
				   // $image->resize(800, 600);
				    $image->save(Yii::app()->basePath.'/../pics/cava/'.$model->imagen);  
                }
	...
	public function actionUpdate($id)
	{
        ...
        if(isset($_POST['Cava']))
        {
            ...
            $_POST['Cava']['imagen'] = $model->imagen;
            ...
            if($model->save()){
                ...
                if(!empty($subiendoImagen)){
                    $subiendoImagen->saveAs(Yii::app()->basePath.'/../pics/cava/'.$model->imagen);
                    $image = Yii::app()->image->load(Yii::app()->basePath.'/../pics/cava/'.$model->imagen);
				    //$image->resize(800, 600);
				    $image->save(Yii::app()->basePath.'/../pics/cava/'.$model->imagen);  
                } 
	...
	{
		$dataProvider=new CActiveDataProvider('Cava');
	...
	{
		$model=new Cava('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Cava']))
			$model->attributes=$_GET['Cava'];
	 ...
	 * @param Cava $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='Cava-form')
		{
