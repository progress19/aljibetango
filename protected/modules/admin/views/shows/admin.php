...
$this->titulo = '<i class="fa fa-fw fa-music"></i> Shows';
...
<?php
    ...
    array(
           'name'=>'titulo_es',
           'value' => 'CHtml::link($data->titulo_es, Yii::app()->createUrl("admin/shows/update",array("id"=>$data->primaryKey)))',
           'header' => 'Título',
...
'value' => '($data->adwords != "") ? "<a class=\"fa fa-fw fa-external-link\" href=\"http://laventanaweb.com/site/shop/$data->idShow\" target=\"_new\"></a>" : ""',
   	...
   	array(
        ...
        'filter'=>'',
        'type'=>'html',
        'value'=>'(!empty($data->imagen))?CHtml::image(Yii::app()->baseUrl."/pics/shows/".$data->imagen,"",array("style"=>"height:50px")):"no imagen"',
     	'headerHtmlOptions'=>array('height'=>'10px'),
     ),
 ...
 array(
    ...
    'viewButtonUrl'=>'Yii::app()->createUrl("/admin/shows/update?id=$data->idShow" )', // url de la acción 'update'
    )),));
