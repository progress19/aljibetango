<?php
/* @var $this CavaController */
/* @var $model Cava */
/* @var $form CActiveForm */
?>

<?php $this->menu_cava = 'active';  ?>
 	...
 	<div class="col-md-10">
 		<div class="box box-success">
              ...
              <div class="nav-tabs-custom">
                ...
                <div style="overflow: auto;" class="tab-content">
                  ...
                  <div class="tab-pane active" id="tab_1">
				    ...
				    <div class="col-md-4">
				    	<a target="_new" style="float: right;" class="btn btn-success" href="<?php echo URLRAIZ.'/shopdeg/'.$model->idShow.'/'.urls_amigables($model->titulo_es).'/es'; ?>">	
                  ...
                  <div class="tab-pane" id="tab_2">
				    ...
				    <div class="col-md-4">
				    	<a target="_new" style="float: right;" class="btn btn-success" href="<?php echo URLRAIZ.'/shopdeg/'.$model->idShow.'/'.urls_amigables($model->titulo_en).'/en'; ?>">	
                  ...
                  <div class="tab-pane" id="tab_3">
				    ...
				    <div class="col-md-4">
				    	<a target="_new" style="float: right;" class="btn btn-success" href="<?php echo URLRAIZ.'/shopdeg/'.$model->idShow.'/'.urls_amigables($model->titulo_pr).'/pt'; ?>">	
                ...
                <div class="tab-pane" id="tab_4">
				    ...
				    <div class="col-md-4">
				    	<a target="_new" style="float: right;" class="btn btn-success" href="<?php echo URLRAIZ.'/shopdeg/'.$model->idShow.'/'.urls_amigables($model->titulo_en).'/zh'; ?>">	
            ...
            <div class="col-md-4">
				...
				<div class="col-md-6">
				<div class="form-group">
					<?php echo $form->labelEx($model,'precio2_4'); ?>
					<?php echo $form->textField($model,'precio2_4',array('size'=>60,'maxlength'=>128,'class' => 'form-control')); ?>
					<?php echo $form->error($model,'precio2_4'); ?>
				</div>	
			    </div>
			    ...
			    <div class="col-md-6">
				<div class="form-group">
					<?php echo $form->labelEx($model,'precio5_15'); ?>
					<?php echo $form->textField($model,'precio5_15',array('size'=>60,'maxlength'=>128,'class' => 'form-control')); ?>
					<?php echo $form->error($model,'precio5_15'); ?>
				</div>	
			    </div>
			    ...
			    <div class="col-md-6">
				<div class="form-group">
					<?php echo $form->labelEx($model,'precio16'); ?>
					<?php echo $form->textField($model,'precio16',array('size'=>60,'maxlength'=>128,'class' => 'form-control')); ?>
					<?php echo $form->error($model,'precio16'); ?>
				</div>	
			    </div>
				...
				<div class="col-md-6">
					<div class="form-group">
						<?php echo $form->labelEx($model,'Duración (min)'); ?>
				...
				<div class="clearfix"></div>
 				...
 				<div class="col-md-2">
 					...
 					<div class="box box-success">
 						...
 						<?php echo CHtml::image(Yii::app()->request->baseUrl.'/pics/cava/'.$model->imagen,"imagen", array('class' => 'img-responsive' )); ?>  
 						<?php } ?>
