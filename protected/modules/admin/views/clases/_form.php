 		...
 		<div class="box box-success">
              ...
              <div class="nav-tabs-custom">
                ...
                <div style="overflow: auto;" class="tab-content">
                  ...
                  <div class="tab-pane active" id="tab_1">
				    ...
				    <div class="col-md-4">
				    	<a target="_new" style="float: right;" class="btn btn-success" href="<?php echo URLRAIZ.'/shopclases/'.$model->idShow.'/'.urls_amigables($model->titulo_es).'/es'; ?>">	
                  ...
                  <div class="tab-pane" id="tab_2">
				    ...
				    <div class="col-md-4">
				    	<a target="_new" style="float: right;" class="btn btn-success" href="<?php echo URLRAIZ.'/shopclases/'.$model->idShow.'/'.urls_amigables($model->titulo_en).'/en'; ?>">	
                  ...
                  <div class="tab-pane" id="tab_3">
				    ...
				    <div class="col-md-4">
				    	<a target="_new" style="float: right;" class="btn btn-success" href="<?php echo URLRAIZ.'/shopclases/'.$model->idShow.'/'.urls_amigables($model->titulo_pr).'/pt'; ?>">	
                ...
                <div class="tab-pane" id="tab_4">
				    ...
				    <div class="col-md-4">
				    	<a target="_new" style="float: right;" class="btn btn-success" href="<?php echo URLRAIZ.'/shopclases/'.$model->idShow.'/'.urls_amigables($model->titulo_en).'/zh'; ?>">	
            ...
            <div class="col-md-4">
				...
				<div class="form-group">
					...
					<?php echo $form->textField($model,'precio1',array('size'=>60,'maxlength'=>128,'class' => 'form-control')); ?>
				...
				<div class="form-group">
					...
					<?php echo $form->textField($model,'precio2',array('size'=>60,'maxlength'=>128,'class' => 'form-control')); ?>
			    ...
			    <div class="col-md-6">
				<div class="form-group">
					<?php echo $form->labelEx($model,'precio3_6'); ?>
					<?php echo $form->textField($model,'precio3_6',array('size'=>60,'maxlength'=>128,'class' => 'form-control')); ?>
					<?php echo $form->error($model,'precio3_6'); ?>
				</div>	
			    </div>

			    <div class="col-md-6">
				<div class="form-group">
					<?php echo $form->labelEx($model,'precio7_10'); ?>
					<?php echo $form->textField($model,'precio7_10',array('size'=>60,'maxlength'=>128,'class' => 'form-control')); ?>
					<?php echo $form->error($model,'precio7_10'); ?>
				</div>	
			    </div>

			    <div class="col-md-6">
				<div class="form-group">
					<?php echo $form->labelEx($model,'precio11_19'); ?>
					<?php echo $form->textField($model,'precio11_19',array('size'=>60,'maxlength'=>128,'class' => 'form-control')); ?>
					<?php echo $form->error($model,'precio11_19'); ?>
				</div>	
			    </div>

			    <div class="col-md-6">
				<div class="form-group">
					<?php echo $form->labelEx($model,'precio20'); ?>
					<?php echo $form->textField($model,'precio20',array('size'=>60,'maxlength'=>128,'class' => 'form-control')); ?>
					<?php echo $form->error($model,'precio20'); ?>
				</div>	
			    </div>
				...
				<div class="col-md-6" id="divFecha">
					...
					<div class="col-md-6" id="divHasta">
					<div class="form-group">
				...
				<div class="clearfix"></div>
 				...
 				<div class="col-md-2">
 					...
 					<div class="box box-success">
 						...
 						<?php echo CHtml::image(Yii::app()->request->baseUrl.'/pics/clases/'.$model->imagen,"imagen", array('class' => 'img-responsive' )); ?>  
 						<?php } ?>
