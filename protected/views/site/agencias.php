...
<html lang="en">
  <head>
    ...
    <title>.:: Encuesta Agencias - La Ventana ::.</title>
...
<?php if (isset($_REQUEST['cli']) && isset($_REQUEST['idcli'])) : ?>
...
<div class="container" style="padding-top: 1em;">
  ...
  <div class="col-md-12" id="est">
    ...
    <form id="frmAgencias" class="form-horizontal">
...
<?php else : ?>
  ...
  <p style="text-align:center">
    Debe especificar id de Cliente y Nombre.
  </p>
