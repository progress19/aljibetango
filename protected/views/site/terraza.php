  ...
  <section id="terraza-int" class="container">
   <div class="inner">
        ...
        <h1 style="font-size: 33px;" class="white cursiva">
          <?php echo Yii::t('strings', 'Rooftop'); ?>
        </h1>
    ...
    <div class="box-cava" id="clases">
      <div class="col-md-12 fondo-escuela no-padding">
        ...
        <div class="col-md-7 no-padding">
          ...
          <div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/386224584?title=0&byline=0&portrait=0" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe></div>
